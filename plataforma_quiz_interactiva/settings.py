"""
Django settings for plataforma_quiz_interactiva project.
...
WSGI_APPLICATION = 'plataforma_quiz_interactiva.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = [
    'https://9b33-157-100-109-39.ngrok-free.app',
]